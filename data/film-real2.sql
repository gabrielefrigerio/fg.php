...
-- Dump della struttura del database film-real
CREATE DATABASE IF NOT EXISTS `film-real` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `film-real`;
...
CREATE TABLE IF NOT EXISTS `film` (
  ...
  `regista` varchar(50) NOT NULL DEFAULT '?',
  ...
  `descr_breve` text NOT NULL DEFAULT '...',
...
REPLACE INTO `film` (`id`, `titolo`, `descrizione`, `anno`, `durata`, `regista`, `lingua`, `settings`, `trailer`, `casa_produttrice`, `voto`, `descr_breve`, `genere`, `media`, `copertina`) VALUES
	...
	(1, 'Dune 2', '', '2024', 0, '', NULL, NULL, NULL, NULL, 0, '', 'avventura', 'Film', 'FALSE'),
	(2, 'I goonies', '', '0000', 0, '', NULL, NULL, NULL, NULL, 0, '', 'avventura', 'Film', 'FALSE'),
	(3, 'Indiana jones 2', '', '0000', 0, '', NULL, NULL, NULL, NULL, 0, '', 'avventura', 'Film', 'FALSE'),
	...
	(6, 'Il silenzio degli innocenti', '', '0000', 0, '', NULL, NULL, NULL, NULL, 0, '', 'horror', 'Film', 'TRUE'),
	(7, 'C era una volta ad hollywood', '', '0000', 0, '', NULL, NULL, NULL, NULL, 0, '', 'drammatico', 'Film', 'TRUE'),
	(8, 'Forrest gump', '', '0000', 0, '', NULL, NULL, NULL, NULL, 0, '', 'commedia', 'Film', 'TRUE'),
	(9, 'Breaking bad', '', '0000', 0, '', NULL, NULL, NULL, NULL, 0, '', 'azione', 'Serie', 'TRUE'),
	(10, 'Better call saul', '', '0000', 0, '', NULL, NULL, NULL, NULL, 0, '', 'drammatico', 'Serie', 'TRUE'),
	(11, 'fight club', '', '0000', 0, '', NULL, NULL, NULL, NULL, 0, '', 'azione', 'Film', 'TRUE'),
	(12, 'the Iron claw', '', '2023', 0, '', NULL, NULL, NULL, NULL, 0, '', 'drammatico', 'Film', 'TRUE'),
	(13, 'il gande lebowski', '', '0000', 0, '', NULL, NULL, NULL, NULL, 0, '', 'commedia', 'Film', 'TRUE'),
	(14, 'joker', '', '0000', 0, '', NULL, NULL, NULL, NULL, 0, '', 'drammatico', 'Film', 'TRUE'),
	(15, 'oppenheimer', '', '2023', 0, '', NULL, NULL, NULL, NULL, 0, '', 'drammatico', 'Film', 'TRUE'),
	(16, 'bullet train', '', '2022', 0, '', NULL, NULL, NULL, NULL, 0, '', 'azione', 'Film', 'TRUE'),
	(17, 'mad max', '', '2024', 0, '', NULL, NULL, NULL, NULL, 0, '', 'azione', 'Film', 'TRUE'),
	...
	(19, 'I griffin', '', '0000', 0, '', NULL, NULL, NULL, NULL, 0, '', 'animazione', 'Serie', 'FALSE'),
	(20, 'the mandalorian', '', '0000', 0, '', NULL, NULL, NULL, NULL, 0, '', 'azione', 'Serie', 'TRUE'),
	(21, 'atlanta', '', '2016', 0, '', NULL, NULL, NULL, NULL, 0, '', 'drammatico', 'Serie', 'TRUE'),
	(22, 'the whale', '', '2022', 0, '', NULL, NULL, NULL, NULL, 0, '', 'horror', 'Film', 'TRUE'),
	(23, 'saltburn', '', '2023', 0, '', NULL, NULL, NULL, NULL, 0, '', 'romantico', 'Film', 'TRUE'),
	...
	(25, 'the bear', '', '2022', 0, '', NULL, NULL, NULL, NULL, 0, '', 'drammatico', 'Serie', 'FALSE');
...
-- Dump dei dati della tabella film-real.preferiti: ~2 rows (circa)
REPLACE INTO `preferiti` (`id_utente`, `id_film`) VALUES
	(7, 8),
	(7, 18);
...
-- Dump dei dati della tabella film-real.utenti: ~4 rows (circa)
REPLACE INTO `utenti` (`nome`, `cognome`, `id`, `username`, `password`, `conferma`, `email`, `nazionalità`, `età`) VALUES
	('', '', 4, 'fvvd', 'ovjr', NULL, 'ivroer', NULL, NULL),
	('', '', 5, 'the ciccio', '1234', NULL, 'Tormene', NULL, NULL),
	('', '', 6, 'franco', '4321', NULL, 'FRIGG', NULL, NULL),
	('asdf', 'asdf', 7, 'asd', 'asd', NULL, 'asda', NULL, NULL);
